...
export class AppComponent {
  ...
  actualizar_lista(){
    ...
    if(this.bProgramaSimple){
      ...
      this.crearMamifero(new Mamifero("Perro","ladra", "Interno", 4, "omnivoro", "en tierra", "terrestre", "pelaje"), this.animals.length -1);
      this.crearMamifero(new Mamifero("Gato","maulla", "Interno", 4, "omnivoro", "en tierra", "terrestre", "pelaje"), this.animals.length );
      this.crearMamifero(new Mamifero("Leon","ruge", "Interno", 4, "carnivoro", "en tierra", "terrestre", "pelaje"), this.animals.length );
      this.crearMamifero(new Mamifero("Ornitorrinco","grazna", "Interno", 4, "carnivoro", "en tierra y en agua", "terrestre y acuatico", "pelaje"), this.animals.length );
